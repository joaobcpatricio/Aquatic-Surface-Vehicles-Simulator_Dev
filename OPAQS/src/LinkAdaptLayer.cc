...
void LinkAdaptLayer::handleMessage(cMessage *msg)
{
    ...
    if (msg->isSelfMessage()) {
        ...
        if (strstr(gateName, "BTlowerLayerIn") != NULL && dynamic_cast<NeighbourListMsgBT*>(msg) != NULL) {
            ...
            std::string SouceDAdd = dataMsg->getSourceAddress();
            ...
            std::string SouceAAdd = ackMsg->getSourceAddress();
            ...
            /*int i=0;
                i=beaconMsg->getNic();
                if(i==1){*/
            std::string SouceBAdd = beaconMsg->getSourceAddress();
            ...
            std::string SouceDRAdd = dataRequestMsg->getSourceAddress();
            //int a=0;
